async function carregarAlunos() {
    ...
    try {
        ...
        const response = await fetch(`${API}/aluno/turma/${codTurma}?page=0&size=50`, {
            method: "GET",
            headers: {
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="py-4 text-center">
                        ...
                        <button
                            ...
                            onclick="window.location.href='cadPontoDisc.html?rm=${aluno.rmAluno}&idDisc=${idDisc}&codTurma=${codTurma}'">
