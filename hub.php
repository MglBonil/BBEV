  ...
  <aside class="sidebar">
    ...
    <nav class="nav-section">
      ...
      <a class="nav-item" href="#">
        <img src="assets/icons/wallet.svg" alt="icone pontos">
    ...
    <nav class="nav-section">
      ...
      <a class="nav-item" href="#">
        <img src="assets/icons/menu.svg" alt="icone justificativas">
        <span class="nav-text">Justificativas</span>
      </a>
      <a class="nav-item" href="#">
        <img src="assets/icons/archive.svg" alt="icone relatorio">
        <span class="nav-text">Relatório</span>
      </a>
      <a class="nav-item" href="#">
        <img src="assets/icons/add.svg" alt="icone cadastro">
